INSERT INTO next_challenge_local.users (grade,created_at,english_name,login_id,username,department,password,profile_image_url,`role`) VALUES
	 ...
	 (1,NULL,'Kim Minji','12180001','김민지','컴퓨터공학과','1234',NULL,'STUDENT'),
	 (2,NULL,'Park Jisoo','12190002','박지수','소프트웨어학과','1234',NULL,'STUDENT'),
	 (3,NULL,'Lee Junho','12200003','이준호','정보통신공학과','1234',NULL,'STUDENT'),
	 (4,NULL,'Choi Yuna','12210004','최유나','전자공학과','1234',NULL,'STUDENT'),
	 (1,NULL,'Han Seojin','12220005','한서진','데이터사이언스학과','1234',NULL,'STUDENT'),
	 (2,NULL,'Jung Taeyang','12230006','정태양','기계공학과','1234',NULL,'STUDENT'),
	 (3,NULL,'Yoon Haerin','12240007','윤해린','산업경영공학과','1234',NULL,'STUDENT');
INSERT INTO next_challenge_local.users (grade,created_at,english_name,login_id,username,department,password,profile_image_url,`role`) VALUES
	 (4,NULL,'Kang Dohyun','12250008','강도현','인공지능학과','1234',NULL,'STUDENT');
